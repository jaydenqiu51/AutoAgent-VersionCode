...
FULL_CATALOG = [
    ...
    ("Kimi (Moonshot)", "kimi-k2-0711-preview", "moonshotai/kimi-k2", None),
    ("Kimi (Moonshot)", "kimi-k2-turbo-preview", None, None),
    ("Kimi (Moonshot)", "kimi-latest", None, None),
    ("Kimi (Moonshot)", "kimi-thinking-preview", None, None),
    ("Kimi (Moonshot)", "moonshot-v1-8k", None, None),
    ("Kimi (Moonshot)", "moonshot-v1-32k", None, None),
    ("Kimi (Moonshot)", "moonshot-v1-128k", None, None),
    ("Kimi (Moonshot)", "moonshot-v1-auto", None, None),
