...
| **Kimi (Moonshot)** | kimi-k3 | $0.88 / $10.53 | Paid key | [platform.moonshot.cn](https://platform.moonshot.cn) |
...
_All prices in USD ($) · Last updated: 2026-09-25 03:25 UTC · auto-refreshes every 2 hours_
<!-- PRICING:END -->
...
| OpenRouter | `moonshotai/kimi-k3` | $0.88 / $10.53 |
| OpenRouter | `moonshotai/kimi-k2.7-code` | $0.66 / $3.30 |
...
| Kimi (Moonshot) | `kimi-k3` | $0.88 / $10.53 |
| Kimi (Moonshot) | `kimi-k2.7-code` | $0.66 / $3.30 |
