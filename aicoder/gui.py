...
MODEL_CATALOG = {
    "openai": [
        ...
        ("gpt-4.1-mini", None), ("gpt-4.1-nano", None), ("o3", None),
        ("o3-mini", None), ("o4-mini", None), ("gpt-4-turbo", None),
        ("gpt-3.5-turbo", None),
    ],
    "anthropic": [
        ("claude-sonnet-4-20250514", None), ("claude-opus-4-20250514", None),
        ("claude-3-7-sonnet-20250219", None), ("claude-3-5-sonnet-20241022", None),
        ("claude-3-5-haiku-20241022", None), ("claude-3-haiku-20240307", None),
    ],
    "gemini": [
        ("gemini-2.5-flash", "freetier"), ("gemini-2.5-flash-lite", "freetier"),
        ("gemini-2.0-flash", "freetier"), ("gemini-2.0-flash-lite", "freetier"),
        ("gemini-1.5-flash", "freetier"), ("gemini-2.5-pro", None),
        ("gemini-1.5-pro", None),
    ],
    "ollama": [
        ("llama3.3", "free"), ("llama3.2", "free"), ("llama3.1", "free"),
        ("llama3.2-vision", "free"), ("codellama", "free"), ("qwen2.5-coder", "free"),
        ("qwen3", "free"), ("deepseek-coder-v2", "free"), ("deepseek-r1", "free"),
        ("mistral", "free"), ("mistral-nemo", "free"), ("mixtral", "free"),
        ("phi4", "free"), ("phi4-mini", "free"), ("gemma3", "free"),
        ("gemma2", "free"), ("codegemma", "free"), ("codestral", "free"),
        ("starcoder2", "free"), ("granite3.3", "free"),
    ],
    "deepseek": [("deepseek-chat", None), ("deepseek-reasoner", None)],
    "groq": [
        ("llama-3.3-70b-versatile", "freetier"), ("llama-3.1-8b-instant", "freetier"),
        ("deepseek-r1-distill-llama-70b", "freetier"), ("qwen-2.5-coder-32b", "freetier"),
        ("qwen-qwq-32b", "freetier"), ("gemma2-9b-it", "freetier"),
        ("mixtral-8x7b-32768", "freetier"),
    ...
    "openrouter": [
        ...
        ("google/gemini-2.5-pro", None), ("x-ai/grok-4", None),
    ],
    "qwen": [
        ("qwen-max", None), ("qwen-plus", None), ("qwen-turbo", None),
        ("qwen3-coder-plus", None), ("qwen3-coder-flash", None), ("qwen-long", None),
    ],
    "kimi": [
        ("kimi-k2-0711-preview", None), ("kimi-k2-turbo-preview", None),
        ("kimi-latest", None), ("moonshot-v1-8k", None),
        ("moonshot-v1-32k", None), ("moonshot-v1-128k", None),
    ],
    "glm": [
        ("glm-4-flash", "freetier"), ("glm-4.5-flash", "freetier"),
        ("glm-4.5", None), ("glm-4.5-air", None), ("glm-4.5-x", None),
        ("glm-4-plus", None), ("glm-4-air", None), ("glm-4-long", None),
    ],
}
