...
| **Kimi (Moonshot)** | kimi-k3 | $2.65 / $13.28 | Paid key | [platform.moonshot.cn](https://platform.moonshot.cn) |
...
_All prices in USD ($) · Last updated: 2026-09-16 10:50 UTC · auto-refreshes every 2 hours_
<!-- PRICING:END -->
...
| OpenRouter | `moonshotai/kimi-k3` | $2.65 / $13.28 |
| OpenRouter | `moonshotai/kimi-k2.7-code` | $0.71 / $3.21 |
...
| Kimi (Moonshot) | `kimi-k3` | $2.65 / $13.28 |
| Kimi (Moonshot) | `kimi-k2.7-code` | $0.71 / $3.21 |
