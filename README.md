...
| **Kimi (Moonshot)** | kimi-k3 | $1.70 / $8.50 | Paid key | [platform.moonshot.cn](https://platform.moonshot.cn) |
...
_All prices in USD ($) · Last updated: 2026-09-20 13:56 UTC · auto-refreshes every 2 hours_
<!-- PRICING:END -->
...
| OpenRouter | `moonshotai/kimi-k3` | $1.70 / $8.50 |
...
| Kimi (Moonshot) | `kimi-k3` | $1.70 / $8.50 |
