...
_All prices in USD ($) · Last updated: 2026-09-22 17:55 UTC · auto-refreshes every 2 hours_
<!-- PRICING:END -->
...
| OpenRouter | `moonshotai/kimi-k2.7-code` | $0.71 / $3.30 |
...
| Kimi (Moonshot) | `kimi-k2.7-code` | $0.71 / $3.30 |
